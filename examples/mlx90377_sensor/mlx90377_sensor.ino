...
void loop() {
  ...
  if((ti - last_print) > 500) {
    last_print = ti;
    Serial.printf("1: state:%d angle:%d temp:%.2f°C err:%d pkt:%d\r\n",
        mlx90377.getStatus(), mlx90377.getRawAngle(), mlx90377.getTemperature(), mlx90377.getErrorCount(), mlx90377.getPacketCount());
